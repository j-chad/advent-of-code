...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `45.4µs` | `58.3µs` |
| [Day 2](./src/bin/02.rs) | `115.9µs` | `207.8µs` |
| [Day 3](./src/bin/03.rs) | `41.4µs` | `46.1µs` |
| [Day 4](./src/bin/04.rs) | `332.4µs` | `54.0µs` |
| [Day 5](./src/bin/05.rs) | `13.7ms` | `14.1ms` |
| [Day 6](./src/bin/06.rs) | `2.0ms` | `-` |
